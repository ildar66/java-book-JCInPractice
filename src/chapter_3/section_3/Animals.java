 ...
 *         For primitively typed local variables, such as numPairs in loadTheArk in @see {@link Animals}, you cannot violate stack confinement
 *         even if you tried. There is no way to obtain a reference to a primitive variable, so the language semantics ensure that primitive
